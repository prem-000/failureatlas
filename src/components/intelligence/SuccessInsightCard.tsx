...
export function SuccessInsightCard({ insight }: Props) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full items-start text-left">
      <div className="flex flex-col gap-3 w-full">
        ...
        {/* Algorithmic insight */}
        <div style={{ background: '#0f1f2f', border: '1px solid #1e3a5f', borderRadius: 10, padding: '14px 16px', minWidth: 0, overflowWrap: 'anywhere' }}>

...
export function FailureNode({ data, selected }: NodeProps) {
  ...
  return (
    <>
      ...
      `}</style>
      <div className="failure-node-container" style={{
        ...
        <div className="failure-node-title" style={{ color: '#f4f4f5', fontWeight: 600, lineHeight: 1.35 }}>{label}</div>
